...
const shopItems = [
  { title: 'Powdered Meals', image: 'https://huel.imgix.net/VisualNav_PowderedMeals.png?auto=format&compress&w=500', highlight: false },
  { title: 'Bundles', image: 'https://huel.imgix.net/VisualNav_Bundles-UK.png?auto=format&compress&w=500', highlight: false },
  { title: 'Ready-to-drink Meals', image: 'https://huel.imgix.net/VisualNav_Ready-to-drink_Meals_(UK).png?auto=format&compress&w=500', highlight: false },
  { title: 'Hot Instant Meals', image: 'https://huel.imgix.net/VisualNav_HotSavoury_LiteRamenONLY.png?auto=format&compress&w=500', highlight: false },
  { title: 'Greens & Superfoods', image: 'https://huel.imgix.net/VisualNav_Green&Superfoods-UK.png?auto=format&compress&w=500', highlight: false },
  { title: 'Drinks & Snacks', image: 'https://huel.imgix.net/VisualNav_EnergyDrinksBars_(UK).png?auto=format&compress&w=500', highlight: false },
];
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3.5 min-w-0">
        <img src={image} alt={title} className="w-20 h-15 object-contain shrink-0" />
        <span className="text-xl font-bold text-neutral-900 truncate">{title}</span>
      </div>
      <span className="flex h-9 w-9 items-center justify-center rounded-full bg-white shrink-0 shadow-sm border border-neutral-100 transition-transform group-hover:translate-x-0.5">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-neutral-800">
