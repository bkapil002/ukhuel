...
export default function DrinksSnacks() {
  const [activeTab, setActiveTab] = useState('Meal Replacement Shakes');
  const [openIndex, setOpenIndex] = useState(0);
  const faqs = [
    {
      q: 'How do you recommend using Everyday Nutrition?',
      a: 'We generally recommend using Huel Everyday Nutrition products as a way to increase the amount of vitamins, minerals, and nutrients you consume in your diet. Many of our customers use them as a replacement for regular snacks, drinks, and meals. For example, if you normally drink a can of sugary beverage at lunch, then using Huel can be a great alternative. Not only do you get a tasty and refreshing drink, but it also contains far more nutrients than a traditional can of pop.',
    },
    {
    ...
    <div className="w-full bg-white font-sans select-none pb-16">
      ...
      <nav className="w-full bg-[#f6f4ee] border-b border-neutral-200/40 py-3 sm:py-3.5">
        <div className="max-w-[1654px] mx-auto px-4 sm:px-6 lg:px-10 flex items-center gap-1.5 text-[11px] sm:text-xs font-semibold text-neutral-500">
          ...
          <span className="text-neutral-400 font-normal select-none">&gt;</span>
          <span className="text-neutral-800">Everyday Nutrition - Drinks & Snacks</span>
        </div>
      </nav>
      {/* Hero Banner Section */}
      <div className="relative w-full h-56 sm:h-72 md:h-80 lg:h-[380px] overflow-hidden">
        ...
        <img
          src="https://cdn.sanity.io/images/sy0wkh9n/productionv29/954ae84b79f9d2aa92b62b3a2b8fa85a512375bd-2880x577.png?auto=format&fit=max&q=75&w=2000"
        ...
        <div className="absolute inset-0 z-10 max-w-[1654px] mx-auto px-4 sm:px-6 lg:px-10 flex flex-col justify-end pb-8 sm:pb-12">
          <div className="max-w-3xl text-left">
            ...
            Everyday Nutrition - Drinks & Snacks
            </h1>
          </div>
        </div>
      </div>
