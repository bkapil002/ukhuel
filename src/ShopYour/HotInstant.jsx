...
export default function HotInstant() {
  const [activeTab, setActiveTab] = useState('Meal Replacement Shakes');
  const [openIndex, setOpenIndex] = useState(0);
  const faqs = [
    {
      q: 'Are instant meals healthy?',
      a: 'Instant meals can be said to be healthy, but it depends on the ingredients and how you use them. Huel Hot & Savoury instant meals were designed by nutritionists to include a complete range of macronutrients and 26 vitamins and minerals, so that they are nutritionally complete. This means they give you all the nutrients your body needs in a meal. In this sense, they can be seen as a healthy option. But they are not intended as a replacement for all meals - instead, they can be used as part of a healthy, balanced diet. ',
    },
    {
    ...
    <div className="w-full bg-white font-sans select-none pb-16">
      ...
      <nav className="w-full bg-[#f6f4ee] border-b border-neutral-200/40 py-3 sm:py-3.5">
        <div className="max-w-[1654px] mx-auto px-4 sm:px-6 lg:px-10 flex items-center gap-1.5 text-[11px] sm:text-xs font-semibold text-neutral-500">
          ...
          <span className="text-neutral-400 font-normal select-none">&gt;</span>
          <span className="text-neutral-800">Hot Instant Meals</span>
        </div>
      </nav>
      {/* Hero Banner Section */}
      <div className="relative w-full h-56 sm:h-72 md:h-80 lg:h-[380px] overflow-hidden">
        ...
        <img
          src="https://cdn.sanity.io/images/sy0wkh9n/productionv29/ed63c4b87e6719a234b92f4acebd1bf45138f72c-2880x577.jpg?auto=format&fit=max&q=75&w=2000"
