...
export default function GreensSuperfoods() {
  const [activeTab, setActiveTab] = useState('Meal Replacement Shakes');
  const [openIndex, setOpenIndex] = useState(0);
  const faqs = [
    {
      q: 'Are green powders worth it?',
      a: 'Greens powders and superfood powders offer a convenient way to consume a wide variety of greens and ‘superfoods’. These products use dried and powdered ingredients that give you access to the antioxidants, adaptogens, minerals, and vitamins that you would otherwise get from eating the ingredients individually. By combining many plants, vegetables, fruit, and more in a single greens powder or drink, it’s simply a lot easier for you to include more of these ingredients in your diet, compared to buying, preparing, and cooking them yourself.',
    },
    {
    ...
    <div className="w-full bg-white font-sans select-none pb-16">
      ...
      <nav className="w-full bg-[#f6f4ee] border-b border-neutral-200/40 py-3 sm:py-3.5">
        <div className="max-w-[1654px] mx-auto px-4 sm:px-6 lg:px-10 flex items-center gap-1.5 text-[11px] sm:text-xs font-semibold text-neutral-500">
          ...
          <span className="text-neutral-400 font-normal select-none">&gt;</span>
          <span className="text-neutral-800">Greens & Superfoods Powders</span>
        </div>
      </nav>
      {/* Hero Banner Section */}
      <div className="relative w-full h-56 sm:h-72 md:h-80 lg:h-[380px] overflow-hidden">
        ...
        <img
          src="https://cdn.sanity.io/images/sy0wkh9n/productionv29/4c27ff3b0db18bc0fb8f230333f90fcd880391a5-2880x577.jpg?auto=format&fit=max&q=75&w=2000"
